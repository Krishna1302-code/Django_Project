...
from ..models import Student_data,Faculty,Subject
...
def Home_page(request):
    ...
    return render(request,'home_page.html',{'total_students_enrolled':total_students_enrolled,'count_total_faculty':count_total_faculty,'total_subject':total_subject})
